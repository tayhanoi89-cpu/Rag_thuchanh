"""Buổi 08 semantic baseline adapted from Buổi 07.

This file is a copied baseline from Buổi 07 with the same loader, validator,
embedding helper, and Chroma indexer flow. It is intentionally isolated from the
Buổi 07 runtime and uses the Buổi 08 workspace paths for .env and storage.
"""
